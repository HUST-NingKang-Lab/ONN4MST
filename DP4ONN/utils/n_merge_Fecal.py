...
def getMatricesFiles():
	with open('Fecal_npzs.txt', 'r') as f:
		l = f.readlines()
	l = {int(i.rstrip('.npz\n').split('_')[-1]) : i for i in l}
	nl = []
	k = list(l.keys())
	k.sort()
	# print(k)
	for i in k:
		nl.append(l[i].rstrip('\n'))
	return nl
...
if __name__ == "__main__":
	...
	savez('matrices/merged_Fecal',matrices=matrices,label_0=label_0,label_1=label_1,label_2=label_2,label_3=label_3,label_4=label_4,label_5=label_5)
	'''
