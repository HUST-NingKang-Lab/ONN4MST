...
You need also indicate a mapping file containing paths of your input ".tsv" files using `-mp` option. Usually, this mapping file would be automatically generated by `preprocess.py convert`. You can find it under the output folder `.data/npzs/`.
